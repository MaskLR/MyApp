...
//        ) {
//            composable(Route.Home.route) { HomeScreen(hiltViewModel()) } // 首页，注入 ViewModel
//            composable(Route.Discover.route) { DiscoverScreen(hiltViewModel()) } // 发现页，注入 ViewModel
//            composable(Route.Me.route) { MeScreen(hiltViewModel()) } // 我的页面，注入 ViewModel
//        }
//    }
//}
//
